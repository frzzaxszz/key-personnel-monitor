      ...
      <div class="modal">
        ...
        <div class="modal-body">
          <div class="photo-box">
            ...
            <div v-else class="photo-preview empty">无照片</div>
            <input type="file" accept="image/*" @change="onPhotoChange" class="input" style="width: 100%" />
          </div>
          <div class="form-grid">
            ...
            <label>所属地区<select v-model="form.district" class="select"><option v-for="d in options.districts" :key="d">{{ d }}</option><option value="北京市">北京市</option></select></label>
...
.page-head h2 { font-size: 20px; color: #fff; letter-spacing: 1px; }
